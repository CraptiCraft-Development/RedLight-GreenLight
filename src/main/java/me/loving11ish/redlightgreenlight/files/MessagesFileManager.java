package me.loving11ish.redlightgreenlight.files;
...
public class MessagesFileManager {
    ...
    public MessagesFileManager(RedLightGreenLight plugin){
        this.plugin = plugin;
    ...
    public void saveMessagesConfig() {
        ...
        try {
            ...
            MessageUtils.sendConsole("severe", "&4Could not save messages.yml");
            MessageUtils.sendConsole("severe", "&4Check the below message for the reasons!");
            e.printStackTrace();
        }
    }
